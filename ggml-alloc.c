...
struct ggml_tallocr ggml_tallocr_init(ggml_backend_buffer_t buffer) {
...
void ggml_tallocr_alloc(struct ggml_tallocr * talloc, struct ggml_tensor * tensor) {
    // TODO: handle view initialization here
...
static bool alloc_tensor_range(struct ggml_context * ctx,
    ...
    struct ggml_tallocr tallocr = ggml_tallocr_init(buffer);
